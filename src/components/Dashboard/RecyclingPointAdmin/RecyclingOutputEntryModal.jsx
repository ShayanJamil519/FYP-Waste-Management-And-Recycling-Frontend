...
const RecyclingOutputEntryModal = ({ setOpenRecyclingOutputEntryModal }) => {
  return (
    <Modal onClose={setOpenRecyclingOutputEntryModal}>
      <div
        style={{
          boxShadow:
...
export default RecyclingOutputEntryModal;
